...
<body>
    ...
    <script>
        // --- Initialization Data ---
        const initialText = `<strong>Bravo !</strong><br><br>

Vous avez officiellement gagné <strong>200 points</strong> sur le <i>leader borde</i> ! 🎉<br><br>

Félicitations d'avoir parcouru <strong>tous ces fichiers</strong> juste pour me trouver...<br>
<i>Vous êtes soit très déterminé, soit très perdu.</i><br><br>

<strong>Dans tous les cas, respect.</strong><br>`;
